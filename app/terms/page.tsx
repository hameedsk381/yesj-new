          ...
          <div className="container px-4 md:px-6 max-w-4xl">
            <div className="space-y-6 text-muted-foreground font-extralight">
              <div>
                ...
                <p className="mb-4">
                  By accessing and using the YESJ website and services, you agree to be bound by these Terms of Service.
              ...
              <div>
                ...
                <p className="mb-4">
                  Membership in YESJ is subject to the following conditions:
                </p>
              ...
              <div>
                ...
                <p className="mb-4">
                  Participation in YESJ events and programs is governed by:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>Registration fees are non-refundable unless the event is cancelled by YESJ</li>
                  <li>Participants must adhere to event rules and code of conduct</li>
                  <li>YESJ reserves the right to cancel or modify events due to unforeseen circumstances</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Represent YESJ positively in all activities</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="mb-4">
                  All content on this website, including text, images, logos, and materials, is the property of YESJ
              ...
              <div>
                ...
                <p className="mb-4">
                  YESJ reserves the right to modify these Terms of Service at any time. Changes will be effective
