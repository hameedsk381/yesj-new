...
export default function GalleryPage() {
  ...
  const recentImages = [
    {
      ...
      description: "APTSAICUF Members celebrating patriotism with the Indian flag",
    },
    {
    ...
    },
    {
      ...
      description: "AICUF permanent installation on campus grounds",
    },
    {
    ...
    },
    {
      ...
      description: "AICUF members at Joseph's College for Women receiving recognition",
    },
    {
      ...
      description: "AICUF members participating in #DRUGFREE365 awareness campaign",
    },
    {
    ...
    },
    {
      ...
      alt: "AICUF Members Group Photo",
      description: "AICUF Regional Conference Group Photo",
    },
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/aicuf2-xbFCelykLM73SyDcujcgpNHQGKgwGu.jpeg",
      alt: "AICUF Flag Raising Ceremony",
      description: "AICUF Flag Raising Ceremony with Student Members",
    },
    {
      src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/aicuf1-owoq2CuFOpRHrTCHMmVcaJl9tmK08g.jpeg",
      alt: "AICUF Centenary Display",
      description: "AICUF Marching Into Centenary - 100 Years Photo Display",
    },
  ]
  ...
  const categories = [
    ...
    },
    {
      ...
      description: "Performances and cultural events organized by APTSAICUF",
    },
  ]
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1">
        ...
        {categories.map((category) => (
          ...
          >
            <div className="container px-4 md:px-6">
              <SectionHeader title={category.title} description={category.description} subtitle="APTSAICUF in Action" />
              <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
                {[1, 2, 3, 4].map((num) => (
                  <div key={num} className="group relative overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                      <p className="text-white text-sm font-light">APTSAICUF {category.title} Initiative</p>
                    </div>
                  </div>
                ))}
              </div>
