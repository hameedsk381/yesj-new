...
export const metadata = {
  title: "News & Updates",
  description: "Latest news, updates, and announcements from APTSAICUF. Stay informed about our activities and initiatives.",
  openGraph: {
    title: "News & Updates | APTSAICUF",
    description: "Latest news, updates, and announcements from APTSAICUF.",
    url: "https://aptsaicuf.org/news",
    type: "website",
  },
}
...
export default function NewsPage() {
  const newsArticles = [
    {
      id: 1,
      title: "APTSAICUF Celebrates 100 Years of Student Activism",
    ...
    {
      id: 5,
      title: "Flood Relief Efforts: APTSAICUF Members Serve Affected Communities",
    ...
    },
    {
      ...
      excerpt: "We're excited to welcome our newest chapter, expanding APTSAICUF's reach and impact to more students across the region.",
      date: "2024-07-12",
      ...
      <main className="flex-1" id="main-content" role="main">
        ...
        <section className="w-full py-12 md:py-20 bg-white">
          <div className="container px-4 md:px-6">
            <SectionHeader
              title="Latest News"
              description="Recent updates from APTSAICUF"
                  ...
                  >
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="inline-block px-3 py-1 text-xs font-semibold text-white bg-maroon rounded-full">
                          {article.category}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-light text-maroon mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                        {article.title}
                      </h3>
